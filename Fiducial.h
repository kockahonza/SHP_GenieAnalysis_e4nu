...
struct Fiducial {
  ...
  // apapadop // Nov 23 2020 // Narrow band 30 deg in phi and either accepting ALL theta or theta_pos > 12 deg (piplus & protons) and
  // theta_pi- > 30
  ...
  TF1 *up_lim1_ec, *up_lim2_ec, *up_lim3_ec, *up_lim4_ec, *up_lim5_ec, *up_lim6_ec, *low_lim1_ec, *low_lim2_ec, *low_lim3_ec, *low_lim4_ec,
      *low_lim5_ec, *low_lim6_ec;
  TF1 *leftside_lim1_ec, *leftside_lim2_ec, *leftside_lim3_ec, *leftside_lim4_ec, *leftside_lim5_ec, *leftside_lim6_ec, *rightside_lim1_ec,
      *rightside_lim2_ec, *rightside_lim3_ec, *rightside_lim4_ec, *rightside_lim5_ec, *rightside_lim6_ec;
  ...
  //  750A Torus Current
  const Double_t fgPar_1Gev_750[6][6][4] = {{{0.898182469399665, 0.009415220076383, -0.000321553327295, 0.000003360299566},
  ...
  // 1500A Torus Current
  const Double_t fgPar_1Gev_1500[6][6][4] = {{{0.927522250807456, 0.006838093705586, -0.000216634914610, 0.000002126491398},
  ...
  const Double_t fid_1gev_750_pimifid_S5[2][2][4] = {{{111.088, 7.4495, -0.810668, 0.0314985}, {119.088, 7.4495, -0.810668, 0.0314985}},
                                                     //{{19.2082, 1.65144, 0.661954, -0.165823}, {18.2403, 8.87948 ,-5.21333, 1.28453}},
  ...
  // sector 1 has 1 gap
  const Double_t fid_1gev_750_pimifid_S1[2][4] = {{113.259, 10.763, -2.45037, 0.201482}, {135.89, 1.31017, -0.27533, 0.0355386}};
  ...
  // sector 3 has 4 gaps, first argument is the # of gaps, second corresponds to upper and lower limits of gap, the last one is the number
  // of parameters
  ...
  // sector 5 has 4 gaps, first argument is the # of gaps, second corresponds to upper and lower limits of gap, the last one is the number
  // of parameters
  ...
  // 2.2 GeV parameters
  const Float_t fgPar_2GeV_2250_Efid[6][6][9] = {{{62.2935, -92.5133, 87.0360, -38.4696, 6.3177, 0, 0, 0, 0},
  ...
  const Float_t fgPar_2GeV_2250_Pfid_ScpdS3[8][6] = {
      {17.1490, 294.605, -640.590, 707.758, -386.730, 83.2529},  {35.9318, 204.580, -404.489, 413.240, -209.580, 41.7819},
      {47.6825, 274.777, -754.725, 1117.80, -846.816, 255.607},  {44.7484, 344.543, -872.200, 1113.89, -694.736, 168.061},
      {-205.978, 828.617, -1199.65, 875.482, -317.846, 45.6938}, {-240.595, 961.068, -1370.34, 977.625, -345.743, 48.3834},
      {-136.104, 479.276, -593.135, 374.730, -118.350, 14.7923}, {-196.773, 700.974, -894.540, 577.460, -185.690, 23.6201}};
  ...
  const Float_t fgPar_2GeV_2250_Pfid_ScpdS5[8][6] = {
      {-29.9426, 370.963, -714.697, 707.343, -348.995, 67.7647},  {-27.4173, 372.536, -693.341, 652.792, -302.559, 54.7761},
      {-47.1617, 132.967, -104.776, 41.7673, -7.68238, 0.404311}, {-54.5895, 149.685, -111.590, 41.2556, -6.93943, 0.301087},
      {-79.1386, 275.678, -341.972, 218.907, -69.5520, 8.66381},  {-97.5794, 352.616, -468.487, 322.829, -111.159, 15.0975},
      {22.5823, -182.064, 365.317, -294.653, 108.779, -15.2712},  {-7.59521, 2.91795, 31.6773, -28.3085, 10.5943, -1.57966}};
  ...
  // 2 and 4 GeV pi- fiducial parameters (the pol3 theta gaps, with a sensible variable name, redefined some electron gaps here)
  // sector 1 has 2 gaps
  ...
  // sector 3 has 3 gaps
  const Double_t fid_2gev_2250_pimifid_S3[3][2][4] = {{{112.584, -8.50953, 3.65541, -0.321358}, {99.7915, 11.1871, -1.96114, 0.167723}},
  ...
  // sector 4 has 2 gaps
  const Double_t fid_2gev_2250_pimifid_S4[2][2][4] = {{{99.1183, 3.87431, -0.651923, 0.0541116}, {114.798, -1.74102, 0.670956, -0.0506822}},
                                                      {{17.4548, 12.0517, -1.60906, 0.108019}, {20.2729, 8.8091, -0.0491563, -0.0567015}}};

  // sector 5 has 4 gaps
  const Double_t fid_2gev_2250_pimifid_S5[4][2][4] = {{{99.9404, 24.7386, -5.60018, 0.431221}, {119.312, 13.4537, -2.63984, 0.190205}},
  ...
  // sector 6 has 1 gap
  const Double_t fid_2gev_2250_pimifid_S6[2][4] = {{80.5638, -15.6315, 3.64252, -0.267854}, {51.8427, 10.8915, -2.38221, 0.177976}};
